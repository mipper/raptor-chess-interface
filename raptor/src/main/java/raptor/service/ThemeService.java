...
import raptor.util.ClasspathScanner;
...
public class ThemeService {
    ...
    protected Theme[] loadSystemThemes() {
        ...
        try {
            final List<URL> urlList = new ClasspathScanner(getClass().getClassLoader()).scan(THEME_SYSTEM_DIR,
                                                                                             ".*\\.properties");
            for (URL url: urlList) {
...
//
//            final ClassLoader classLoader = ThemeService.class.getClassLoader();
//            final Enumeration<URL> resources = classLoader.getResources(THEME_SYSTEM_DIR);
...
//            }
    ...
    protected Theme[] loadUserThemes() {
        ...
        List<Theme> themes = new ArrayList<>(10);
